...
function normalizeAnswers(rawAnswers) {
  return {
    ...
    annual_invoice_amount_min: getNumericValue(rawAnswers.annual_invoice_amount, "amount"),
    annual_invoice_amount_max: getNumericValue(rawAnswers.annual_invoice_amount, "amount") * 1.5,
    
    annual_tax_amount_min: getNumericValue(rawAnswers.annual_tax_amount, "tax"),
    annual_tax_amount_max: getNumericValue(rawAnswers.annual_tax_amount, "tax") * 1.5,
...
*本文档是整个贷款体检器系统的核心业务逻辑说明，请开发团队严格按照此逻辑实现。*
